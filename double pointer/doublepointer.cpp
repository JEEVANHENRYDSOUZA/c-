...
int main(){
    ...
    int *b=&c;
    pointer(b);
    int **double_pointer =&b;


    //doublepointer points to b and b is pointing to c

    //in other words doublepointer has the address of the pointer b and the pointer b has the address of the variable c
